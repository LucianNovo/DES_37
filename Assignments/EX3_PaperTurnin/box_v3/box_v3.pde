...
void setup()  {
  ...
  for(int i=0; i<cubeCount; i++){
    heightVert[i] = random((horzSpacingInc * marginPercent),(horzSpacingInc * 5));
    widthVert[i]  = random((horzSpacingInc * marginPercent),(horzSpacingInc * marginPercent));
  ...
  String imgPath = ("../../generatedImagesEX3/" + frame.getTitle() + ".png");
  saveFrame(imgPath);
}
